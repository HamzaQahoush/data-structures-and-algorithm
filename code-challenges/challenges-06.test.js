...
const sortByChildren = (charArray) => {
  ...
  charArray.sort((a,b)=>{
    if (parseInt(a.children.length) > parseInt(b.children.length)) return 1;
    else if (parseInt(a.children.length) < parseInt(b.children.length))return -1;
    else if (parseInt(a.house)> parseInt(b.house)) return -1;
    else if (parseInt(a.house)< parseInt(b.house)) return 1;
    else return 0 ;
...
const getCourseKeys = (obj) => {
  // Solution code here...
  let output=Object.keys(courseInfo);
  return output;
};
